...
def prepare_case(case_name: str) -> None:
    ...
    shutil.copy2(fixture / "SPEC.md", run_dir / "SPEC.md")

    print(f"Prepared run: {run_dir}")
    print()
    print("Next steps:")
    print(f"  1. cd {repo_dst}")
    print("  2. Open Codex in that repo")
    print("  3. Follow the task in ../SPEC.md using codex/prompts/impl.md")
    print(f"  4. Score with: python3 codex/evals/runner.py score {run_dir}")
